...
async def scrape_website_content(url: str) -> str:
    ...
    if is_google_search:
        ...
        Identify the URLs of the first 3 organic search result links. IMPORTANT: Ignore ads, sponsored links, 'People also ask' boxes, image/video carousels, and map results. Focus only on the standard blue link textual results typically found below the ads.
        If you find fewer than 3 organic links, use only the ones you find.
