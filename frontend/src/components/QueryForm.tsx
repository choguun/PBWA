  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="mb-4 w-full space-y-4">
      ...
      <button
        ...
        className="w-full mt-2 inline-flex items-center justify-center px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isLoading ? (
          <>
